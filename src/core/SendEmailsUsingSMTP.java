...
public class SendEmailsUsingSMTP { 
	 ...
	 */
	public boolean connectAndSendSmtp(String serverName, String portNo, String secureConnection, String userName, String password, String toEmail, String subject, String msg, String[] attachFiles){
		
		System.out.println("Inside connectAndSendSmtp method: ");
	       emailSettings(serverName, portNo, secureConnection);
	       createSession(userName, password);
		return sendMessage(userName, toEmail,subject,msg, attachFiles);
	}
	...
	public boolean sendMessage(String fromEmail, String toEmail, String subject, String msg, String[] attachFiles) {
